var user,
      ...
      function showUserCreateNewThread() {
        ...
        window.history.pushState({page: 'newThreadPage'}, "New Thread", "./new-thread");
      }
      ...
      function userCreateNewThread() {
        const newThreadTitle = document.getElementById("new-thread-title")
          .value;
        const newThreadContent = document.getElementById("new-thread-content")
          .value;
      ...
      function loadPosts(
        threadId,
        threadItemContainerTag,
        setDingshiRenwu = true
      ) {
